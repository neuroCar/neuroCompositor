...
CMakeFiles/mir-compositor.dir/main.cpp.o: main.cpp \
  ...
  /usr/include/gtk-4.0/gsk/gskblendnode.h \
  ...
  /usr/include/gtk-4.0/gtk/gtksvg.h \
  ...
  /usr/include/mircore/mir/flags.h \
  ...
  /usr/local/include/neuParser.h

mir-compositor: /lib64/ld-linux-x86-64.so.2 \
  /lib64/libc.so.6 \
  /lib64/libgcc_s.so.1 \
  /lib64/libm.so.6 \
  /lib64/libmvec.so.1 \
  ...
  /usr/lib64/libboost_container.so.1.90.0 \
  /usr/lib64/libboost_iostreams.so.1.90.0 \
  /usr/lib64/libboost_program_options.so.1.90.0 \
  /usr/lib64/libboost_random.so.1.90.0 \
  ...
  /usr/lib64/libdisplay-info.so.3 \
  ...
  /usr/lib64/libmircommon.so.11 \
  /usr/lib64/libmircore.so \
  /usr/lib64/libmirplatform.so.34 \
  /usr/lib64/libmirserver.so.66 \
  /usr/lib64/libmirwayland.so.5 \
